...
- [ ] Реализовать визуализацию текущих курсов валют и криптовалют
- [ ] Реализовать исторические графики
- [ ] Реализовать управление уведомлениями (подписки)
- [ ] Реализовать экспорт данных
- [ ] Все запросы — только через API Gateway
...
- [ ] Написать юнит-тесты для каждого сервиса
