...
func main() {
	...
	logrus.Info("Starting Binance Worker")

	// Create Kafka reader for refresh requests
	reader := kafka.NewReader(kafka.ReaderConfig{
		Brokers: cfg.Kafka.Brokers,
		Topic:   string("rates.refresh.requested"),
		GroupID: "binance-worker-group",
	})
	defer reader.Close()

	logrus.Info("Binance Worker started - listening for refresh requests")
	...
	for {
		...
		// TODO: Fetch rates from Binance API
		// TODO: Normalize data
